...
deploy:
	gcloud run deploy fake-news-detector --source . --region europe-west1 --allow-unauthenticated --memory 1Gi --set-secrets GOOGLE_API_KEY=GOOGLE_API_KEY:latest,TAVILY_API_KEY=TAVILY_API_KEY:latest,GCP_SERVICE_ACCOUNT=GCP_SERVICE_ACCOUNT:latest
